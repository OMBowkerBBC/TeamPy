...
window.onload = () => {
  ...
  if (localStorageData !== null) {
    const userSettings = JSON.parse(localStorageData);
    if (userSettings.difficulty == "Expert" && !window.location.href.includes("Expert"))
      window.location.href = `${window.location.href}?dif=Expert`
  }
